...
- TUI tests cover startup, one-shot mode, interactive multi-turn reuse, slash-command resets, rendered status, tool events, session records, abort, and no-key failure.
